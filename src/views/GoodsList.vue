      ...
      <div class="accessory-result-page accessory-page">
        <div class="container">
          <div class="filter-nav">
            ...
            <a href="javascript:;" class="price" @click="sortGoods" v-bind:class="{'sort-up':!sortFlag}">Price <svg class="icon icon-arrow-short"><use xlink:href="#icon-arrow-short"></use></svg></a>
            ...
            axios.get('/goods/list',{
              ...
              if(res.status=="0"){
                if(flag){
                  ...
                  if(res.result.count==0&&res.result.count<8){
                    this.busy=true;
                  }else{
                    this.busy=false
                  }
